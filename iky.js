...
let errorImg = 'https://i.ibb.co/rdZspTH/IMG-20210210-071533-256.jpg'
...
const isImage = (type === 'imageMessage')
     const time2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')
      ...
      const daftar1 = `Hai kak  ${pushname} ${ucapanWaktu} \n\nSebelum Menggunakan MeexyBotVerify Terlebih Dahulu Ya `
      ...
      // GAME 
        ...
        if (game.isfam(from, family100)) {
          ...
          if (tebakata.hasOwnProperty(sender.split('@')[0]) && !isCmd) {
			...
			tc = `MAAF KA NOMER KAMU BLOM TERDAFTAR DI DATABASE SILAHKAN KETIK !verify UNTUK MENDAFTAR DI MeexyBot`
			ind = {
			...
			/////
let ikyads = await getBuffer(`https://i.ibb.co/rdZspTH/IMG-20210210-071533-256.jpg`)
fakelink = (tekslink) => { 
...
reply('BISMILLAH MEEXY')
 tessgc = await getBuffer(`https://i.ibb.co/w0n21TX/20210923-222946.png`)
 ikyy.updateProfilePicture (from, tessgc)
 ikyy.updateProfilePicture (from, tessgc)
                   await sleep(1000)
   ikyy.groupUpdateSubject(from, `🔰JB || MEEXY🔰🐟`)
   await sleep(1000)
   ikyy.groupUpdateDescription(from, `AKAN DI GANTI OLEH MEEXY`)
   await sleep(1000)
ikyy.sendMessage(from, 'yessir jadi gc MEEXY', text, {quoted: mek})
break
case 'sendbug':
...
if (args.length < 2) return reply(`Penggunaan ${command} idgroup`)
        ...
        case 'owner':
        case 'creator':
               sendKontak(from, `6282322427684`, `Meexy`, 'Sibukk!!')
               await sleep(1000)
...
*NOMOR CREATOR*
▼▼▼▼▼`)
sendKontak(from, `6282322427684`, `${ownerName}`, 'Sibukk!!')
               await sleep(1000)
               break
               case 'spamcall':{
...
case 'lock':
 ikymemek = {
  "key": {
    "fromMe": false,
    participant: `6282322437684@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})
  },
  "message": {
    "viewOnceMessage": {
      "message": {
...
🐟 ${prefix}wallgravity text1 text2
 `
sendButMessage(from, wibu, `created MEEXYBOT`, [
          {
            buttonId: `!menu`,
            buttonText: {
...
`
                   sendButMessage(from, wibu, `MeexyBot`, [
          {
            buttonId: `!menu`,
            buttonText: {
              displayText: `⬡ BACK TO MENU `,
...
`
        ...
        case 'wasted':
		      ...
		      buttons = [{buttonId: `!infoig`,buttonText:{displayText: ` Jangan Lupa Follow @MeexyBot`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'MeexyBot', imageMessage: imageMsg,
              contentText:`Jangan Lupa Follow @MeexyBot`,buttons,headerType:4}
...
`
 ...
 MEEXYBOT☕︎`, imageMessage: imageMsg,
               buttons: buttons,
               headerType: 1
}
...
break
			case 'addsticker':
				...
				ikyy.sendMessage(from, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "caption": "_「 の Ｍeexy あ」_", "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('media/Menu.jpg')}}}})
...
break
           ...
           case 'liststicker':
            ...
            case 'done':
              if (!isGroup) return reply(mess.only.group)
              reply('Orderan Dari Buyer Ke MEEXYBOT Telah Berhasil\nTerimakasih Telah Order Di MEEXYBOT 😊\nJangan Lupa Order Kembali👋')
             break
			case 'getvideo':
...
*「 MEEXYBOT 」*`
	    ...
	    // console.log(e)
            setTimeout( () => {
			ikyy.updatePresence(from, Presence.composing)
			reply(`*Terimakasih Telah Mendaftar Di MEEXYBOT🐟*\n*Masuk Gc Bot Yuk ↓*\n*https://chat.whatsapp.com/Kh0TpXCVV5fBNHDiy3PXaa*\n*Terimakasih*`)
		}, 2000)
        break
case 'sfire':
{
...
//------------------< Premium >-------------------
       ...
       case 'sewabot':
              gopeynya = 'https://i.ibb.co/rdZspTH/IMG-20210210-071533-256.jpg'
...
`
  buttons = [{buttonId: `${prefix}owner`,buttonText:{displayText: `Owner👑`},type:1},{buttonId: `${prefix}payment`,buttonText:{displayText: `PAYMENT`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'NOTE📑:HANYA DI MEEXY', imageMessage: imageMsg,
              contentText: teksnya,buttons,headerType:4}
              prep = await ikyy.prepareMessageFromContent(from,{buttonsMessage},{quoted: freply})
              ikyy.relayWAMessage(prep)
              break
...
//------------------< Owner >-------------------
      ...
      case 'broadcast':
             ...
             for (let _ of anu) {
             ikyy.sendMessage(_.jid, bc, image, {quoted:freply,caption: `*「 MeexyBot NEWS 」*\n\n${body.slice(4)}`})
}
             reply('Suksess broadcast')
             } else {
             for (let _ of anu) {
             sendMess(_.jid, `*「 MeexyBot BROADCAST」*\n\n${body.slice(4)}`)
}
             reply('Suksess broadcast')
}
             break
...
//------------------< Lainnya >-------------------
        ...
        case 'tes':
               ...
               break
case 'mikel':
reply('*Halo Bang Saya Meexy Bot🐟*')
break
...
//------------------< Menunya Bang:v >-------------------
      case 'infoig':
             reply(`Jangan Lupa Follow Ig Owner Ya : https://www.instagram.com/meexy_bot/\nDAN\nhttps://www.instagram.com/dani_studento_/`)
             break
      case 'kelgroup':
      case 'gcmikel':
      case 'mikelgc':
